...
const videose =  [
	...
	{ key: 'af', value: '_Bt5l0zCnkM', text: 'El fin de semana pasado' },
	{ key: 'af', value: 'Jlr-qhNXjaI', text: 'Mi viaje a China' },
	...
	return (
		<div style={{ backgroundColor: '#101010', height: '160vh'}}>    
			...
			<div className="video" >
				...
				<div>
					<h3 className="seleccionar-video">
						Select a video of the list:
					</h3>
